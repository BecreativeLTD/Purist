...
const pages = [
  ...
  { url: '/pages/science',                         changefreq: 'monthly', priority: '0.6' },
  { url: '/pages/quality',                         changefreq: 'monthly', priority: '0.6' },
  ...
  { url: '/pages/wall-of-health',                  changefreq: 'monthly', priority: '0.6' },
  { url: '/pages/purist-vs-green-powders',         changefreq: 'monthly', priority: '0.6' },
  { url: '/pages/purist-vs-multivitamins',         changefreq: 'monthly', priority: '0.6' },
  { url: '/pages/purist-vs-meal-replacements',     changefreq: 'monthly', priority: '0.6' },
